    ...
    <Layout>
      <main className="font-font-primary text-[white] ">
        ...
        <h2 className="md:text-5xl text-4xl sm:text-2xl px-4  text-white text-center text-primary font-bold">
          Freelancing,{" "}
          <span className="text-[white] font-bold decoration-double decoration-[#ff0000]">
            Simplified for Students
          </span>
        </h2>
        <div className="md:block hidden">
          <StickyScroll OBJECT={SERVICE_DETAILS} />
        </div>
      ...
      <section className="w-full px-4 md:px-32 my-14 py-10 bg-[black] flex flex-col gap-y-10 justidy-center">
        <p className="text-center text-2xl  w-[70%] self-center">
          ...
          luctus egestas dolor, in efficitur justo tincidunt nec. Etiam
          fermentum justo
        </p>
        <Carousel
          autoPlay
